...
python3 -m PyInstaller --hidden-import google-api-python-client --onefile --icon /home/ubuntu/RenderRob/img/renderrob_icon.ico /home/ubuntu/RenderRob/src/rr_master.py
