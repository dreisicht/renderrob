...
def render_job_to_render_settings_setter(
  ...
  python_command = ['import sys',
                    ...
                    f"rss.set_output_settings(frame_step={frame_step}, xres={x_res}, yres={y_res}, percres={resolution}, high_quality={render_job.high_quality})",  # pylint: disable=line-too-long
                    "rss.custom_commands()"
                    ]
