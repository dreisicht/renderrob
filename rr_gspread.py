...
import util.rr_printing as rr_printing
...
def main():
  ...
  copied_spreadsheet_id = copy_spreadsheet(service, spreadsheet_id)
  drive_service = build('drive', 'v3', credentials=creds)
  read_spreadsheet(service, copied_spreadsheet_id)
